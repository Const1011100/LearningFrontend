...
// ================================================================================================
// ================================================================================================
//*-Week №10 fetchUserData (ChatGPT) (Friday)
/*
Напиши функцію fetchUserData(userId), яка:
Повертає проміс, що виконується через випадковий час (1–3 секунди).
70% шанс, що проміс виконається успішно з даними { id: userId, name: "User<id>" }.
30% шанс, що проміс відхилиться з помилкою "User not found".
 */
// Мій варіант
function fetchUserData(userId) {
  return new Promise((resolve, reject) => {
    const delay = Math.floor(Math.random() * 2000) + 1000; // 1–3 сек
    setTimeout(() => {
      if (Math.random() < 0.7) {
        // 70% шанс успіху
